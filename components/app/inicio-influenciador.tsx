...
const RESUMO = [
  { label: "Sugestões novas", valor: "5", lilas: true },
...
export function InicioInfluenciador({ nomeExibicao }: InicioInfluenciadorProps) {
  return (
    <div className="mx-auto max-w-5xl space-y-8 px-4 py-8 sm:px-6">
      ...
      <section className="space-y-4" aria-labelledby="atalhos-influenciador">
        <h2 id="atalhos-influenciador" className="font-display text-lg font-bold">
          Atalhos
        </h2>

...
export function HomeLogos() {
  return (
    <section
      className="border-b border-lilas/25 bg-white py-10"
      aria-label="Marcas na plataforma"
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <p className="eyebrow-secao text-center">Marcas na plataforma</p>
        <ul className="mt-8 flex flex-wrap items-center justify-center gap-x-10 gap-y-4">
          {MARCAS_EXIBIDAS.map((empresa) => (
            <li key={empresa.id}>
              <span className="font-display text-lilas-escuro/80 text-sm font-semibold tracking-tight sm:text-base">
